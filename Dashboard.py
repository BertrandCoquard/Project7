...
with st.sidebar:
    ...
    st.image(image)
    st.write('Bertrand COQUARD')
    st.write('\n')
    #https://oc-project7-app-9c6f626ab48b.herokuapp.com/
    #
    CUSTOMER_ID_req = requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/cust_id").json()
...
if CUSTOMER_ID:
    ...
    # DONNEES DU CLIENT
    with tabs[0]:
        data_cust = pd.json_normalize(requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/data_cust",
    ...
    with tabs[1]:
        ...
        score = float(pd.json_normalize(requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/predict",
        ...
        feature_imp = requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/feature_imp").text
        ...
        lime_results = pd.read_json(requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/lime",
    ...
    with tabs[2]:
        features_req = requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/features").json()
        Y = st.multiselect("Select the features to display (max 10):", features_req, 
                           'DAYS_BIRTH', max_selections = 10)

        # CHARGEMENT DES DONNEES
        data_cust_scaled = pd.json_normalize(requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/data_cust_for_visu",
                                               params = {"CUSTOMER_ID": CUSTOMER_ID}).json())
        neigh_data = pd.read_json(requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/data_10_neighbors",
                                               params = {"CUSTOMER_ID": CUSTOMER_ID}).text)
        neigh_data = neigh_data.drop(CUSTOMER_ID)
        data = pd.read_json(requests.get("https://frozen-cove-50105-311e5794eba1.herokuapp.com/data_for_visu").text)
